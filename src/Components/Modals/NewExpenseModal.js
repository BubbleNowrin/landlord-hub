        ...
        <div className="modal-box relative">
          ...
          <form onSubmit={handleOnSubmit} className='grid grid-cols-1 gap-3 mt-10'>
            ...
            {/* {
              loading ? (
              ...
              ) : (<label for="dropzone-file" className="w-full flex items-center px-3 py-3 mx-auto text-center bg-white border-2 border-dashed rounded-lg cursor-pointer dark:border-gray-600 dark:bg-gray-900">
                ...
                <h2 className="mx-3 text-gray-400">Upload Receipt</h2>
            ...
            <div className=''>
              <h2 className=" text-gray-400 ml-2">Upload Receipt</h2>
              <input
                type="file"
                name="photo"
